...
const LandingPage: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Hold deg oppdatert med lokale begivenheter og kulturelle aktiviteter.",
    },
    {
    ...
    <Box>
      ...
      <Paper
        sx={{
          ...
          backgroundImage:
            "url(https://images.unsplash.com/photo-1747586007329-a8353cea70e3?q=80&w=2578&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)",
          height: "60vh",
          display: "flex",
          alignItems: "center",
        }}>
        ...
        <Container maxWidth='lg' sx={{ position: "relative" }}>
          ...
          <Typography variant='h5' color='inherit' paragraph>
            ...
            <br></br> Vil du ha din butikk eller arrangement i appen?
          </Typography>
          <Button
            variant='contained'
            size='large'
        ...
        <Grid container spacing={6} alignItems='center'>
          <Grid item xs={12} md={6}>
            ...
            <Typography variant='h6' color='text.secondary' paragraph>
              Din komplette guide til å utforske Fagernes
            </Typography>
            <Typography paragraph>
              Fagernes Appen er din ultimate guide til å oppdage alt som
              Fagernes har å by på. Uansett om du skal planlegge neste
              utfordrende tur eller lete etter lokale erfaringer, dekker vår app
              alt du trenger.
            </Typography>
            <Box sx={{ mt: 4 }}>
        ...
        <Container maxWidth='lg'>
          <Grid container spacing={4} alignItems='center'>
            <Grid item xs={12} md={6}>
              ...
              <Typography paragraph>
                Fagernes er en tradisjonell distrikt i det sentrale, sør-Norge.
                I sentrum av kommunen Nord-Aurdal ligger byen med sine
                handelsgater, bystrand, turmuligheter og severdigheter. Byen er
                kjent for sin naturlige skjønnhet, rike kulturarv, og utendørs
                aktiviteter.
              </Typography>
              <Typography paragraph>
                Vår app hjelper besøkende og lokale å oppdage det beste som
                Fagernes har å by på, fra hiking og ski til lokale restauranter
                og kulturelle begivenheter.
              </Typography>
            </Grid>
            <Grid item xs={12} md={6}>
              <Card>
